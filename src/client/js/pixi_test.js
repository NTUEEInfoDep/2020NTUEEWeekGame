...
PIXI.loader.add(["/assets/num1.png","/assets/num2.png","/assets/num3.png",
"/assets/num4.png","/assets/bullet1.png","/assets/bullet2.png","/assets/bullet3.png",
"/assets/bullet4.png","/assets/icon64.png"])
.load(loadOver);
...
function loadOver(){
    ...
    let bullet1 = new PIXI.Sprite(PIXI.loader.resources["/assets/bullet1.png"].texture);
    let bullet2 = new PIXI.Sprite(PIXI.loader.resources["/assets/bullet1.png"].texture);
    let bullet3 = new PIXI.Sprite(PIXI.loader.resources["/assets/bullet1.png"].texture);
    let bullet4 = new PIXI.Sprite(PIXI.loader.resources["/assets/bullet1.png"].texture);
    let arrow = new PIXI.Sprite(PIXI.loader.resources["/assets/icon64.png"].texture);
}
